...
import com.scwang.smart.refresh.layout.listener.OnMultiPurposeListener;
...
//    }
     ...
     * Recommended {@link com.scwang.smart.refresh.layout.listener.SimpleMultiPurposeListener}
     * 设置多功能监听器
     * 建议使用 {@link com.scwang.smart.refresh.layout.listener.SimpleMultiPurposeListener}
    ...
    public RefreshLayout setOnMultiPurposeListener(OnMultiPurposeListener listener) {
        setOnMultiListener(new SimpleMultiPurposeListener(listener, this));
        return this;
    }
